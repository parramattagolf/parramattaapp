...
export default function MannerHistoryList({ initialHistory }: { initialHistory: HistoryItem[] }) {
    const [displayCount, setDisplayCount] = useState(10)
    
    const visibleHistory = initialHistory.slice(0, displayCount)
    const hasMore = displayCount < initialHistory.length
